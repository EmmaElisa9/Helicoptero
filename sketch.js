...
var boxY, boxPosition, boxleftSprite, boxLeftBody, boxBase, boxBaseBody, boxrightSprite, boxRightBody;
...
function setup() {
	...
	packageBody = Bodies.circle(width/2 , 200 , 5 , {restitution:0.2, friction:0.0, density:10.0, isStatic:true});
